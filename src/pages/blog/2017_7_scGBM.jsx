import prisma from "./images/2017-7-1.png";
import treatments from "./images/2017-7-2.png";
import results from "./images/2017-7-3.png";

const title = "Spinal Cord GBM Survival Analysis";
const blurb = `A systematic review of Spinal Cord GBM with an emphasis on correlations between
treatment and outcome. Includes a brief discussion of immortal time bias.`;
const date = "7/27/2017";
...
##### ![Prisma diagram](${prisma} "prisma diagram") A prisma diagram for the source of the imported records
...
##### ![Treatment vs outcome](${treatments} "Treatment vs outcome") Treatment type/degree versus outcome
...
##### ![characteristics vs outcome](${results} "Characteristics vs outcome") Patient characteristics versus outcome
