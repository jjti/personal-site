import startImg from "./images/2017-8-1.png";
import bentTails from "./images/2017-8-2.png";
import bendAngle from "./images/2017-8-3.png";
import tailsDotProduct from "./images/2017-8-4.png";

const title = "Tubulin with Tails Extended";
const blurb = `MD run with tails extended at the start under an External Electric Field.`;
const date = "8/20/2017";
...
##### ![Tubulin molecule at start](${startImg} "Starting position") The starting position of the simulation after the tails had been extended. Red arrow is dipole vector
...
##### ![Tails extended](${bentTails} "Tails in an extended state") The tails at the end of a run with 200kV/cm, teal, versus 20kV/cm, yellow 
...
##### ![Tail extension compared](${tailsDotProduct} "Tail extension dot-product") Tail extension dot product
...
##### ![Intra-dimer bend angle](${bendAngle} "Tubulin bend angle") The bend angle, measured between centers of H7 alpha helicies as described in [Peng, 2014](http://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1003464)
